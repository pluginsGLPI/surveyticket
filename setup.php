...
define ("PLUGIN_SURVEYTICKET_VERSION", "9.2+1.0");
...
function plugin_init_surveyticket() {
   ...
   if (isset($_SESSION["glpiID"])) {
      ...
      if ($plugin->isActivated('surveyticket')) {
         ...
         $PLUGIN_HOOKS['post_item_form']['surveyticket'] = ['PluginSurveyticketTicket', 'postForm'];

         if (Session::haveRight("config", READ)) {
            $PLUGIN_HOOKS["menu_toadd"]['surveyticket'] = array('config'  => 'PluginSurveyticketMenu');
         }
      }
   }
}
