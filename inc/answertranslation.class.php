...
/**
 * PluginSurveyticketAnswerTranslation Class
 *
**/
class PluginSurveyticketAnswerTranslation extends CommonDBChild {
 ...
 /**
   ...
   **/
   static function canBeTranslated(CommonGLPI $item) {
      ...
      return ($item instanceof PluginSurveyticketAnswer);
   }
