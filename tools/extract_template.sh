...
xgettext *.php */*.php --copyright-holder='SurveyTicket Development Team' --package-name='GLPI - SurveyTicket plugin' --package-version='1.6.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
